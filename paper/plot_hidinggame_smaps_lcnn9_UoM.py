...
if __name__ == "__main__":
    ...
    dataname = 'UoM'
    netname = 'lcnn9'
    data_path = 'D:/Projects/E2ID/code/Composite2Photo/data'
    matefilename = f'Norm_Sorted_Set_test_{netname}_GT_as_Rank1.txt'
    nonmatefilename = f'Norm_Sorted_Set_test_{netname}_Rank2_match_for_Rank1_GT.txt'
    ...
    probes = mate_df.iloc[::3, 0].tolist()
    probe_ids = mate_df.iloc[::3, 1].tolist()
    mates = mate_df.iloc[2::3, 0].tolist()
    nonmates = nonmate_df.iloc[2::3, 0].tolist()
    random.seed(0)
