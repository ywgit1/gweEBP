...
from xfr.inpainting_game.generate_whitebox_saliency_UoM import generate_wb_smaps
import torch
    ...
    try:
        ...
        if params['file'] is None:
            params['file'] = os.path.join(
                xfr.__path__[0],
                'inpainting_game/generate_whitebox_saliency_UoM.py'
            )
        ...
        ntp = generate_wb_smaps(
            ...
            # merge_layers=params['merge_layers'],
            # net_param_package=net_param_package
        )
        success = True
