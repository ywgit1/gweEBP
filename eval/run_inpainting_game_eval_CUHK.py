...
from xfr.inpainting_game.plot_inpainting_game_CUHK import make_inpaintinggame_plots
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        default=os.path.join(xfr_root, 'output', 'inpainting_game', 'CUHK'),
