...
class WhiteboxNetwork(object):
    ...
    def restore_merged_layers(self):
        """ Restore merged layers from set_triplet_classifier() to the original last layer """
        raise
...
class WhiteboxLightCNN9(WhiteboxNetwork):
    ...
    def set_triplet_classifier(self, x_probe, x_mate, x_nonmate):
        ...
        # passed_fc_w = self.fc_w[indicator, :]
        # passed_fc_b = self.fc_b[indicator]
...
class WhiteboxVGG16(WhiteboxNetwork):
    ...
    def restore_merged_layers(self):
        ...
        self.net.fc.weight = nn.Parameter(self.fc_w)
        self.net.fc.bias = nn.Parameter(self.fc_b)
