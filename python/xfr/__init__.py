...
inpaintgame2_dir = os.path.join(xfr_root, 'data', 'inpainting-game', 'UoM')
inpaintgame3_dir = os.path.join(xfr_root, 'data', 'inpainting-game', 'CUHK')
...
inpaintgame_saliencymaps_dir = os.path.join(
    xfr_root, 'data',
    'inpainting-game-saliency-maps', 'UoM')
inpaintgame_CUHK_saliencymaps_dir = os.path.join(
    xfr_root, 'data',
    'inpainting-game-saliency-maps', 'CUHK')
